...
function Profile() {
    ...
    return (
        <div className="profile-setting">
            ...
            <Dialog open={changeNameDialog} onClose={closeDialog} fullWidth maxWidth="sm">
            ...
            <Dialog open={changePassDialog} onClose={closePassDialog} fullWidth maxWidth="sm">
                <DialogTitle>เปลี่ยนรหัสผ่าน</DialogTitle>
                <DialogContent style={{ width: "600px" }}>
                    <div className="register fs-7 ms-2">
                        <div>คุณอาจจะต้องได้เข้าสู่ระบบใหม่<br/>หลังจากที่กดรีเซ็ตรหัสผ่าน</div>
                        <div className="forgot-btn" onClick={ForgotPassword}>Forgot your password?</div>
                    </div>
                </DialogContent>
            </Dialog>
            {loading ? (
                ...
                <div className="d-flex align-items-center">
                    <Skeleton animation="wave" variant="rectangular" width={150} height={150} style={{ borderRadius: "25px" }} />
                    <div>
                        <Skeleton variant="text" animation="wave" height={40} width={200} style={{ marginLeft: "20px" }} />
                        <Skeleton variant="text" animation="wave" height={20} width={200} style={{ marginLeft: "20px" }} />
                    </div>
                </div>
            )}
            {loading ? (
                <div className="mt-5">
                    ...
                    <div className="btn d-flex align-items-center" onClick={changePassword}>
                        <div className="icon">
                ...
                <div style={{ marginTop: "5rem" }}>
                    ...
                    <Skeleton variant="text" animation="wave" height={30} width={200} style={{ marginTop: "20px" }} />
                    <Skeleton variant="text" animation="wave" height={30} width={430} style={{ marginTop: "20px" }} />
                    <Skeleton variant="text" animation="wave" height={30} width={230} style={{ marginTop: "20px" }} />
                    <Skeleton variant="text" animation="wave" height={30} width={330} style={{ marginTop: "20px" }} />
                    <Skeleton variant="text" animation="wave" height={30} width={200} style={{ marginTop: "20px" }} />
                    <Skeleton variant="text" animation="wave" height={30} width={200} style={{ marginTop: "20px" }} />
                </div>
            )}
