...
import CrimePost from '../../layout/Reportpost';
...
function Crime() {
    ...
    const loadData = () => {
        axios
        .get("http://localhost:8080/api/alerts/type/qhoLmTIut2sV06wLcggR")
        .then((res) => {
            setData(res.data);
        ...
        <div>
            <div className="d-flex align-items-center justify-content-between pt-3 ps-5 pe-5">
                ...
                style={{
                    ...
                    <input type="text" className="form-control" placeholder="อุบัติเหตุ" 
            ...
            <div className="post">
                {searchData? searchData.map((post, index) => <CrimePost key={index} rpPost={post} onClickPost={onClickPost} />): ""}
            </div>
